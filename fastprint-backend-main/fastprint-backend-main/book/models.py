...
class BookProject(models.Model):
    ...
    selected_service = models.TextField(blank=True, null=True)
    ...
    # In BookProject model
    is_shipment_prepared = models.BooleanField(default=False)
    ...
    # ✅ NEW FIELD: visible order lifecycle status
