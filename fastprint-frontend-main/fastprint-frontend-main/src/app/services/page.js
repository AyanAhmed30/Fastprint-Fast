...
const Services = () => {
  ...
  const services = [
    {
      ...
      title: "Book Printing",
      description:
        "Personalized book printing for memoirs, novels, cookbooks, workbooks, children's books, and much more.",
      features: [
        "Hardcover & Paperback",
        "Coil Bound & Saddle Stitch",
    ...
    },
    {
      ...
      description:
        "Professional writing services with clear structure, engaging content, and proper formatting for readability.",
      features: [
        "Content Development",
    ...
    },
    {
      ...
      description:
        "Compelling book covers that grab readers' attention and convey the essence of your story perfectly.",
      features: [
        "Striking Imagery",
        "Clear Typography",
    ...
    },
    {
      ...
      description:
        "Complete publishing solutions for both traditional and self-publishing routes with expert guidance.",
      features: [
  ...
  const animateCount = (end, duration = 2000, index) => {
    ...
    const step = () => {
      frame++;
      current = Math.min(start + increment * frame, end);
      setCountValues((prev) => {
  ...
  }, [isVisible["features-visual"], hasAnimatedFeatures]);
    ...
    <div className="services-container">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div
            className="absolute top-20 left-20 w-4 h-4 bg-blue-500 transform rotate-45 animate-bounce"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Everything you need to bring your book from concept to published
              reality with professional excellence
            </p>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold mb-1">
                        {featureCountValues[0].toFixed(1)}
                      </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold mb-1">
                        {featureCountValues[2] >= 1000
                          ? `${(featureCountValues[2] / 1000).toFixed(0)}K+`
                          : `${featureCountValues[2]}+`}
                      </div>
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-200 to-purple-200">
        <div className="mx-auto px-4 sm:px-6 md:px-8 text-center">
          <div
            id="cta"
            data-animate
            className={`transition-all duration-1000 ${
          ...
          >
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center mb-6 leading-tight whitespace-nowrap">
              ...
              <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 bg-clip-text text-transparent block md:inline">
                Book to Life
              </span>
            </h2>

            <p className="text-base sm:text-lg text-black/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
              Join thousands of satisfied authors who have trusted us with their
              publishing dreams. Get started today with a free consultation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-2">
              <button
                className="px-6 py-3 sm:px-8 sm:py-4 bg-blue-500 text-white font-semibold rounded-full hover:bg-purple-600 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
                onClick={() => router.push("/calculator/printbook")}
              >
                Get Started
              </button>
